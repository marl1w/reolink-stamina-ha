...
async def async_get_config_entry_diagnostics(
    ...
    return {
        ...
        # the arithmetic was at fault. `playback_derived` is true where the device stated no
        # PlaybackTime at all and StartTime stood in for it, which no amount of staring at
        # the timestamps would reveal: they agree by construction.
